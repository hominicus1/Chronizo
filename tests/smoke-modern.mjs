...
assert.ok(js.includes('openstreetmap.org/?mlat=')&&js.includes("window.open"),'working external detailed map missing');
...
assert.match(html,/α20/,'visible build version missing');
