...
function base(g){
 ...
 const p=el('g');
 const mapCorners='165,720 515,610 1085,750 735,860';
 ...
 if(customTexture)p.append(el('image',{href:customTexture,x:165,y:610,width:920,height:250,preserveAspectRatio:'xMidYMid slice','clip-path':'url(#map-clip)',class:'map-texture'}));
